class Personagem {
  ...
  #arma;
  #habilidadeEspecial;
  constructor(nome, vida, forca, defesa, nivel, experiencia, classe, magia, arma, habilidadeEspecial) {
...
class Guerreiro extends Personagem {
  #armadura;
  #potenciaAtaque;
  constructor(nome, vida, forca, defesa, nivel, experiencia, classe, magia, arma, habilidadeEspecial,armadura, potenciaAtaque) {
    super(nome,vida,forca,defesa,nivel,experiencia,classe,magia,arma,habilidadeEspecial);
...
class Mago extends Personagem {
  #nivelMagia;
  #elemento;
  constructor(nome,vida,forca,defesa,nivel,experiencia,classe,magia,arma,habilidadeEspecial,nivelMagia, elemento) {
    super(nome,vida,forca,defesa,nivel,experiencia,classe,magia,arma,habilidadeEspecial);
...
class Arqueiro extends Personagem {
  #tipoArco;
  #precisao;
  constructor(nome,vida,forca,defesa,nivel,experiencia,classe,magia,arma,habilidadeEspecial,tipoArco,
  precisao) {
    super(nome,vida,forca,defesa,nivel,experiencia,classe,magia,arma,habilidadeEspecial);
...
class Ladino extends Personagem {
  #habilidadeFurtiva;
  #agilidade;
  constructor(nome,vida,forca,defesa,nivel,experiencia,classe,magia,arma,habilidadeEspecial, habilidadeFurtiva,agilidade) {
    super(nome,vida,forca,defesa,nivel,experiencia,classe,magia,arma,habilidadeEspecial);
...
const guerreiro = new Guerreiro(
  "guerreiro",100,70,50,10,50,45,20,10,30,0,50,20);
...
const arqueiro = new Arqueiro(
  "arqueiro",100,10,30,80,100,20,0,"arco","flechaDivina","flamejante",100);
